...
@section('title', 'Coordinación - Panel Principal')
...
<div class="col-12 content-title-search">
  ...
  <span class="col-4 right">
    <a href="{{ route('coordination.create') }}" class="btn btn-create"><i class="fas fa-lg fa-plus"></i></a>
    <span class="form-group">
      <form action="{{ route('coordination.index') }}" method="get">
...
<table class="table table-content">
    ...
    <tr>
      ...
      <td>
        <div class="btn-group-sm">
          <a href="{{ route('coordination.edit', $user->id) }}" class="btn btn-create"><i class="fas fa-sm fa-edit"></i></a>
          <form method="post" action="{{ route('coordination.destroy', $user->id) }}">
            @method('DELETE')
            @csrf
  ...
  <div class="row justify-content-center">
    {{ $coordinadores->appends(request()->query())->links('paginate.default') }} 
  </div>
</div>
@endsection